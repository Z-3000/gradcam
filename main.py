...
/* Grad-CAM 트리거 카드 (사용 안 해도 스타일 유지 가능) */
.gradcam-trigger-box {
    margin-top: 0rem;
...
if uploaded_file is None:
    st.info("좌측에서 DICOM 또는 X-ray 이미지를 업로드하면 Grad-CAM이 자동으로 생성됩니다.")
else:
    # 파일 로드
